...
### 1.2 Dealing with NA
Different types of missing values found. We modified them separately and then created a new data file containing 1451 observations and 79 variables after removing missing values.
```{r}
all_test <- all
...
########################### I include the variable description in the following section 2.2 ###########################################
########################### If you consider to include some of them as control varibles  in statistic analysis #################################
